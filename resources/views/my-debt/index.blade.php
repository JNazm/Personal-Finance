    ...
    <div class="py-10">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow-sm rounded-2xl p-6">
                ...
                <form method="POST" action="{{ route('my-debt.store') }}">
                    @csrf
                    ...
                    <div class="px-6 pt-5 pb-3">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                            ...
                            <div class="flex items-center gap-2 flex-wrap">
                                ...
                                <form method="POST" action="{{ route('my-debt.destroy', $debt) }}" onsubmit="return confirm('Delete this debt?')">
                                    @csrf @method('DELETE')
                                    ...
                                    @foreach($debt->payments->sortBy('month_index') as $payment)
                                        ...
                                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                                            ...
                                            <td class="py-3 px-4 text-center">
                                                <button type="button"
                                                    data-toggle-url="{{ route('my-debt.toggle', [$debt, $payment->month_index]) }}"
